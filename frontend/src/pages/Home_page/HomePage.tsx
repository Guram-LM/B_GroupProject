...
export const HomePage = () => {
  ...
  return (
    <div className={styles.container}>
      <SliderComponent animals={animals.filter(a => a.img)} />
...
<div className={styles.headerWithSelect}>
  ...
  <select
    ...
    value={curensy}
    onChange={(e) => setCurensy(e.target.value as "GEL" | "USD")}
  >
    ...
    <option value="USD">USD</option>
      ...
      <div className={styles.grid}>
        {animals.map(item => {
          const priceInUSD = rate
            ? (Number(item.price) * rate).toFixed(2)
            : null;
                ...
                <div className={styles.actions}>
                  ...
                  <div className={styles.icons}>
                    <img
                      ...
                      alt="heart"
                      onClick={() =>
                        dispatch(addWishlist({ ...item, id: item.id! }))
                      }
                    />
                    <img
                      src={korb}
